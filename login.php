                                    ...
                                    <div class="card-body">
                                        <form action="validacao.php" method="POST">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="usuario" type="text" placeholder="Digite seu login" />
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <a class="btn btn-primary" href="index.php"><button type="submit" class="btn">Entrar</button></a>
                                            </div>
                                        </form>
                                    </div>
